        ...
        while (isRunning)
        {
            ...
            switch (choice)
            {
                ...
                case "5":
                    ...
                    _service.ChooseDiplomaTheme(_student);
                    _student.Diploma.CalculateDifficulty();
                    _student.Diploma.AssignMark();
                    Console.WriteLine($"\nРезультат: {_student.Diploma.NameOfTheme}");
                    Console.WriteLine($"Підсумкова оцінка за диплом: {_student.Diploma.Mark} балів");
                    break;
