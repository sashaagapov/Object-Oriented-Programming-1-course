namespace lab3agapov_v1
{
    ...
    {
        /// <summary>
        /// Показує доступні команди четвертої версії лабораторної роботи.
        /// </summary>
        public void PrintOptions(Service service)
        {
            ...
            service.PrintToConsole("6. Робота з дипломним проєктом");
            service.PrintToConsole("7. Робота з науковими статтями (Бінарний пошук)");
