...
namespace lab3agapov_v1
{
    ...
    public class Teacher
    {
        ...
        {
            int[] paperIds = new int[] { 101, 205, 308, 412, 550 };
            int paperIndex;
            ...
            studyMaterial = "Демо-матеріал: static class і робота з файлами";
            ...
            student.Diploma.ThemeName = "Демо-тема: електронний журнал кафедри";
            student.Diploma.MethodsCount = 6;
            student.Diploma.ThemeComplexity = 42;
            ...
            paperIndex = ScientificPaper.BinarySearchPaper(paperIds, 308);
            service.PrintToConsole("ScientificPaper виконав пошук ID 308. Результат: індекс " + paperIndex + ".");
        ...
        private void SearchScientificPaper(Service service)
        {
            ...
            targetId = ReadNumberInRange(service, "Введіть ID статті для пошуку", 1, 1000);
