...
{
    /// <summary>
    /// Клас Program містить точку входу для запуску фінальної версії лабораторної роботи 3.
    /// </summary>
    class Program
    {
        /// <summary>
        /// Ініціалізує повний набір сутностей та запускає меню з файловою обробкою і алгоритмами пошуку.
        /// </summary>
