...
HTML-документація коду може бути згенерована через Doxygen на основі XML-коментарів у файлах `LAB_3_V4`. Основна версія `LAB_3_V4` підготовлена до генерації документації.
