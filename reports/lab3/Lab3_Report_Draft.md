...
[ВСТАВИТИ ТОЧНЕ ФОРМУЛЮВАННЯ УМОВИ]
...
Місце для вставки зображення:

- `reports/lab3/images/Lab3_ClassDiagram.png`
- [ВСТАВИТИ PNG ДІАГРАМИ]
...
- `reports/lab3/images/Lab3_UseCaseDiagram.png`
- [ВСТАВИТИ PNG ДІАГРАМИ]
...
Місце для посилання на згенеровану документацію:

- [ВСТАВИТИ ПОСИЛАННЯ НА DOXYGEN]
...
## 10. Місце для скріншотів виконання

- [lab3_01_main_menu.png](/Users/agapov/Desktop/LAB_OOP/reports/lab3/screenshots/images/lab3_01_main_menu.png) — показано стартовий екран програми з головним меню; підтверджено запуск меню та наявність основних пунктів сценарію `LAB_3`.
- [lab3_04_create_student.png](/Users/agapov/Desktop/LAB_OOP/reports/lab3/screenshots/images/lab3_04_create_student.png) — показано введення та створення об'єкта студента; підтверджено виконання пункту меню `3`.
- [lab3_05_add_grade.png](/Users/agapov/Desktop/LAB_OOP/reports/lab3/screenshots/images/lab3_05_add_grade.png) — показано додавання оцінки студенту через консоль; підтверджено виконання пункту меню `4`.
- [lab3_06_save_student_to_file.png](/Users/agapov/Desktop/LAB_OOP/reports/lab3/screenshots/images/lab3_06_save_student_to_file.png) — показано виведення даних студента та запис у файл; підтверджено виконання пункту меню `5`.
- [lab3_08_diploma_mark.png](/Users/agapov/Desktop/LAB_OOP/reports/lab3/screenshots/images/lab3_08_diploma_mark.png) — показано результат роботи з дипломним проєктом і підсумкову оцінку; підтверджено виконання пункту меню `6`.
- [lab3_09_search_scientific_paper.png](/Users/agapov/Desktop/LAB_OOP/reports/lab3/screenshots/images/lab3_09_search_scientific_paper.png) — показано пошук ID у масиві посилань наукової статті; підтверджено виконання пункту меню `7`.

Додаткові скріншоти виконання:

- [lab3_02_create_teacher.png](/Users/agapov/Desktop/LAB_OOP/reports/lab3/screenshots/images/lab3_02_create_teacher.png) — показано створення викладача та первинне виведення його даних; підтверджено виконання пункту меню `1`.
- [lab3_03_update_teacher_load.png](/Users/agapov/Desktop/LAB_OOP/reports/lab3/screenshots/images/lab3_03_update_teacher_load.png) — показано оновлення навантаження викладача; підтверджено виконання пункту меню `2`.
- [lab3_10_program_exit.png](/Users/agapov/Desktop/LAB_OOP/reports/lab3/screenshots/images/lab3_10_program_exit.png) — показано коректне завершення роботи програми; підтверджено сценарій виходу через пункт меню `0`.
...
У лабораторній роботі №3 реалізовано консольний застосунок з поділом на предметні та технічні класи. У програмі використано конструктори, властивості `get/set`, `partial class`, вкладений клас, `static class` і роботу з текстовими файлами. Для версії `LAB_3_V4` підготовлено UML-діаграми, контрольний приклад і основу для звіту; вручну ще потрібно вставити скріншоти, PNG-експорти діаграм, точне формулювання умови та посилання на Doxygen.
