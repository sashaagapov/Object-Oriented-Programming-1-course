namespace lab4agapov_v4
{
    ...
    public class Menu
    {
        ...
        /// <summary>
        /// Допоміжна група студентів для демонстрації інтерфейсів.
        /// </summary>
        ...
        public Menu(Service service, Teacher teacher, Student student, StudentGroup group)
        {
        ...
        public void Run()
        {
            ...
            while (isRunning)
            {
                ...
                service.PrintToConsole("8. Перебрати студентів через foreach");
                service.PrintToConsole("9. Відсортувати студентів за рейтингом");
                service.PrintToConsole("10. Відсортувати студентів за кількістю виконаних робіт");
        ...
        /// <summary>
        /// Перебирає студентів через foreach і виводить їхні дані.
        /// </summary>
        private void ShowStudentsByForeach()
        {
            service.PrintToConsole("\n--- Студенти групи ---");

            foreach (Student currentStudent in group)
            {
                service.PrintToConsole("Студент: " + currentStudent.StudentName);
                service.PrintToConsole("Дисципліна: " + currentStudent.SubjectName);
                service.PrintToConsole("Рейтинг: " + currentStudent.CalculateRating());
                service.PrintToConsole("Виконано робіт: " + currentStudent.TasksDone);
                service.PrintToConsole("");
            }
        }

        /// <summary>
        /// Сортує студентів за рейтингом і показує результат.
        /// </summary>
        private void SortStudentsByRating()
        {
            group.SortStudents();
        ...
        /// <summary>
        /// Сортує студентів за кількістю виконаних робіт і показує результат.
        /// </summary>
        private void SortStudentsByTasks()
        {
            group.SortByTasks();
