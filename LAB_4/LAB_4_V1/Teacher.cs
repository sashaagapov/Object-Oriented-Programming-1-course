...
namespace lab4agapov_v1
{
    ...
    /// Він містить предметну логіку взаємодії зі студентом.
    /// </summary>
    public class Teacher : Person
    {
        ...
        public void RunDemoScenario(Service service, Student student)
        {
            ...
            service.PrintToConsole("Створено студента:\n" + student.GetInfo());

            studyMaterial = "Демо-матеріал: успадкування та protected-конструктори";
