...
namespace LAB_6_V2
{
    ...
    public class Service
    {
        ...
        public Service()
        {
            versionTitle = "Версія 2: інтерфейс ISmartDevice";
            protocolFilePath = Path.Combine(Directory.GetCurrentDirectory(), "refrigerator_protocol_v2.txt");
        ...
        /// <summary>
        /// Друкує заголовок поточної версії лабораторної роботи.
        /// </summary>
        ...
        /// <summary>
        /// Друкує попереджувальне повідомлення.
        /// </summary>
        /// <param name="message">Текст повідомлення.</param>
        ...
        /// </summary>
        /// <param name="message">Повідомлення для протоколу.</param>
        ...
        /// <summary>
        /// Виводить повідомлення у вказаному кольорі та одразу додає його до протоколу.
        /// </summary>
        /// <param name="message">Текст повідомлення.</param>
