...
{
    /// <summary>
    /// Технічний сервіс для консольного виводу, вводу і запису протоколу.
    /// </summary>
    public class Service
    {
        ...
        /// <summary>
        /// Ініціалізує сервіс зі стандартним файлом протоколу.
        /// </summary>
        public Service()
        {
            versionTitle = "Версія 3: користувацькі винятки";
            protocolFilePath = Path.Combine(Directory.GetCurrentDirectory(), "refrigerator_protocol_v3.txt");
            protocolLines = new List<string>();
        }

        /// <summary>
        /// Ініціалізує сервіс з заданим шляхом до файлу протоколу.
        /// </summary>
        ...
        /// <summary>
        /// Друкує заголовок поточної лабораторної версії.
        /// </summary>
        ...
        /// <summary>
        /// Друкує повідомлення про успішне завершення дії.
        /// </summary>
        /// <param name="message">Текст повідомлення.</param>
        ...
        /// <summary>
        /// Зчитує рядок із консолі та заносить його в протокол.
        /// </summary>
        ...
        /// <summary>
        /// Зчитує ціле число з перевіркою формату.
        /// </summary>
        /// <param name="prompt">Підказка для користувача.</param>
        ...
        /// <summary>
        /// Зчитує число з плаваючою комою з повторенням до коректного вводу.
        /// </summary>
        /// <param name="prompt">Підказка для користувача.</param>
        ...
        /// <summary>
        /// Додає один або кілька рядків до внутрішнього протоколу з часовою позначкою.
        /// </summary>
        ...
        /// <summary>
        /// Внутрішній допоміжний метод для кольорового виводу і паралельного протоколювання.
        /// </summary>
        /// <param name="message">Текст повідомлення.</param>
        /// <param name="color">Колір повідомлення.</param>
