...
{
    /// <summary>
    /// Технічний клас меню для інтерактивного режиму третьої версії.
    /// </summary>
    public class Menu
    {
        /// <summary>
        /// Виводить список команд, доступних у ручному сценарії.
        /// </summary>
        /// <param name="service">Технічний сервіс для консольної взаємодії.</param>
        ...
        /// <summary>
        /// Зчитує номер команди, яку обрав користувач.
        /// </summary>
