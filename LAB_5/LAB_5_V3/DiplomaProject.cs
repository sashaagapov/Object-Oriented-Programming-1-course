namespace lab5agapov_v3
{
    ...
    public class DiplomaProject
    {
        ...
        /// <summary>
        /// Створює копію дипломного проєкту.
        /// </summary>
        /// <param name="other">Об'єкт, дані якого копіюємо.</param>
        public DiplomaProject(DiplomaProject other)
        {
            // Копіюємо всі змістові атрибути теми та керівництва.
            ThemeName = other.ThemeName;
            AlgorithmsCount = other.AlgorithmsCount;
            Difficulty = other.Difficulty;
            // Згідно з методичкою, копія створюється без оцінки (обнуляємо).
            Mark = 0;
