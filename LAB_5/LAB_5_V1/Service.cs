...
namespace lab5agapov_v1
{
    ...
    public class Service
    {
        ...
        /// <summary>
        /// Виводить повідомлення в консоль і додає його у протокол.
        /// </summary>
        /// <param name="text">Текст повідомлення для виведення.</param>
        ...
        /// </summary>
        /// <param name="fileName">Назва або шлях до файлу протоколу.</param>
