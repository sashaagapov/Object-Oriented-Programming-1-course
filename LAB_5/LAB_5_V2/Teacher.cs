...
namespace lab5agapov_v2
{
    ...
    public class Teacher : Person
    {
        ...
        public void RunDemoScenario(Service service, Student student, DiplomaProject project)
        {
            ...
            studyMaterial = "Демо-матеріал: operator overloading у V2";
            ...
            service.WriteToFile(service.AppendProtocol(BuildReport(student, project)));
            service.SaveProtocolToFile("lab5_v2_protocol.txt");
            service.PrintToConsole("Демонстраційний звіт і протокол сформовано.");
        }

        public void RunScenario(Service service, Menu menu, Student student, DiplomaProject project)
        {
            bool isRunning = true;
            int command;
            ...
            while (isRunning)
            {
                ...
                {
                    case 1:
                        ShowInformation(service, student, project);
                        break;
                    case 2:
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        SaveData(service, student, project);
                        break;
                    case 0:
                        isRunning = false;
        ...
        private void ShowInformation(Service service, Student student, DiplomaProject project)
        {
            service.PrintToConsole("\n--- Дані викладача ---");
        ...
        private void SaveData(Service service, Student student, DiplomaProject project)
        {
            service.WriteToFile(service.AppendProtocol(BuildReport(student, project)));
            service.PrintToConsole("Дані збережено у файл");
        }

        private string BuildReport(Student student, DiplomaProject project)
        {
